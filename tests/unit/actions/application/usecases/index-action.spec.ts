...
test.group('Unit | Actions | IndexActionUseCase', () => {
  test('it should return a paginated list of actions', async ({ assert }) => {
  ...
  test('it should return the second page of actions', async ({ assert }) => {
    const fakeRepository = new FakeActionRepository()
  ...
  test('it should return an empty list when no actions exist', async ({ assert }) => {
    const fakeRepository = new FakeActionRepository()
