...
import {
  InvalidMissionStepTransitionError
} from '#app/modules/missions/domain/exceptions/invalid-mission-step-transition-error'
...
export default class MissionStep {
  ...
  get order() { return this._sequenceOrder }
